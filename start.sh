#存放在 /usr/local/bin/
#赋予可执行 chmod +x /usr/local/bin/start.sh
# ===============================

# 固定脚本目录
BASE_DIR="/home/learning"
WX_SCRIPT="$BASE_DIR/learning.py"
...
show_status() {
    ...
    echo -e "当前脚本状态："
    if [ -n "$wx_pid" ]; then
        echo -e "learning.py        : \e[32m已启动 (PID: $wx_pid)\e[0m"
    else
        echo -e "learning.py        : \e[31m未启动\e[0m"
    fi
    echo -e "======================================"
}
